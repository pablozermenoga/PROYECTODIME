...
$cmb_post_option = new_cmb2_box( array(
	...
	'title'         => esc_html__( 'Post Options', "doctor-toolkit" ),
...
$cmb_post_gallery = new_cmb2_box( array(
	...
	'title'         => esc_html__( 'Gallery Post Options', "doctor-toolkit" ),
	'object_types'  => array( 'post' ), // Post type
	'context'       => 'normal',
	'priority'      => 'high',
	'show_names'    => true, // Show field names on the left
...
$cmb_post_gallery->add_field( array(
	'name' => esc_html__( 'Post Gallery', 'doctor-toolkit' ),
...
$cmb_post_video = new_cmb2_box( array(
	...
	'title'         => esc_html__( 'Video Post Options', "doctor-toolkit" ),
	'object_types'  => array( 'post' ), // Post type
	'context'       => 'normal',
	'priority'      => 'high',
	'show_names'    => true, // Show field names on the left
...
$cmb_post_video->add_field( array(
	...
	'default'          => 'video_link',
	'options'          => array(
		'video_link' => esc_html__( 'Video Link', "doctor-toolkit" ),
		'video_embed_code'   => esc_html__( 'Video Embed Code', "doctor-toolkit" ),
		'video_upload_local'   => esc_html__( 'Upload Local File', "doctor-toolkit" ),
	),
) );
...
$cmb_post_audio = new_cmb2_box( array(
	...
	'title'         => esc_html__( 'Audio Post Options', "doctor-toolkit" ),
	'object_types'  => array( 'post' ), // Post type
	'context'       => 'normal',
	'priority'      => 'high',
	'show_names'    => true, // Show field names on the left
...
$cmb_post_audio->add_field( array(
	...
	'options'          => array(
		'soundcloud_link' => esc_html__( 'Soundcloud Link', "doctor-toolkit" ),
		'audio_upload_local'   => esc_html__( 'Upload Local File', "doctor-toolkit" ),
	),
) );
