...
?>
<header class="header_s header_s1 header_s8 header_s9<?php echo esc_attr($sticky_menu); ?>">
	<?php 
	...
	<nav class="navbar ownavigation">
		...
		<div class="container">
			...
			<?php if( doctor_options("opt_header_contact") != "" ) { ?><a href="tel:<?php echo esc_attr(str_replace(" ", "", doctor_options("opt_header_contact") ) ); ?>" title="<?php echo esc_attr(str_replace(" ", "", doctor_options("opt_header_contact") ) ); ?>" class="phone-call"><i class="fa fa-phone-square"></i><?php echo esc_attr( doctor_options("opt_header_contact") ); ?></a><?php } ?>
				...
				<?php
					...
					if( $nav != "" && $nav != "0" ) {
						wp_nav_menu( array(
							...
							'depth' => 10,
							'menu_class' => 'nav navbar-nav menubar navbar-left',
