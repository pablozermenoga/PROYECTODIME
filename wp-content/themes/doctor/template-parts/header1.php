...
?>
<header class="header_s header_s1<?php echo esc_attr($sticky_menu); ?>">
	<?php
					...
					<div class="container">
						<?php 
							if( doctor_options("opt_header_contactsec") != "" || doctor_options("opt_header_email") != "" ) {
								?>
								<div class="call-info">
									<?php if( doctor_options("opt_header_contactsec") != "") { ?><p><a href="tel:<?php echo esc_attr(str_replace(" ", "", doctor_options("opt_header_contactsec") ) ); ?>" title="<?php echo esc_attr( doctor_options("opt_header_contactsec") ); ?>" class="phone"><i class="fa fa-phone"></i><?php echo esc_attr( doctor_options("opt_header_contactsec") ); ?></a></p><?php } ?>
	...
	<nav class="navbar ownavigation">
		...
		<div class="container">
			...
			<?php
				if( doctor_options("opt_header_contact") != "" || doctor_options("opt_header_email") != "" || doctor_options("opt_social_icons") != "" ) {
					?>
