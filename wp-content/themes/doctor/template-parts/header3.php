...
?>
<header class="header_s header_s1 header_s2 header_s3<?php echo esc_attr($sticky_menu); ?>">
	<!-- Logo Block -->
	<div class="logo-block">
		...
		<div class="container">
			<?php
				if( $plogo != "" ) { 
					?>
					<a class="navbar-brand mobile-hide full-view-logo image-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>">
				...
				elseif( doctor_options('opt_logotype') == "2" && $limg != "" ) { // Logo - Image
					?>
					<a class="navbar-brand mobile-hide full-view-logo image-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" <?php if( $logo_w != "px" && $logo_h != "px" ) { ?>style="<?php if( $logo_w != "px" ) { ?>max-width: <?php echo esc_attr( $logo_w ); ?>; <?php } ?> <?php if( $logo_h != "px" ) { ?>max-height: <?php echo esc_attr( $logo_h ); ?>;<?php } ?>"<?php } ?>>
				...
				elseif( doctor_options('opt_logotype') == "1" && $lsitetitle != "" ) { // Logo - Site Title
					?>
					<a class="navbar-brand mobile-hide full-view-logo site-title" href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<?php 
				...
				elseif( doctor_options('opt_logotype') == "3" && $lcustomtxt != "" ) { // Logo - Custom Text
					?>
					<a class="navbar-brand mobile-hide full-view-logo custom-txt" href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<?php 
							if( doctor_options("opt_menuicon_switch") != "0" ) {
								if( doctor_options("opt_logo_icon") != "" ) {
									?><i class="<?php echo esc_attr( doctor_options("opt_logo_icon") ); ?>"></i>
		...
		<div class="container">
			<div class="navbar-header">
				...
				<?php
					if( $plogo != "" ) { 
						?>
						<a class="navbar-brand desktop-hide mobile-logo image-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>">
							<img src="<?php echo esc_url( $plogo ); ?>" alt=""  />
						</a>
						<?php
					}
					elseif( doctor_options('opt_logotype') == "2" && $limg != "" ) { // Logo - Image
						?>
						<a class="navbar-brand desktop-hide mobile-logo image-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" <?php if( $logo_w != "px" && $logo_h != "px" ) { ?>style="<?php if( $logo_w != "px" ) { ?>max-width: <?php echo esc_attr( $logo_w ); ?>; <?php } ?> <?php if( $logo_h != "px" ) { ?>max-height: <?php echo esc_attr( $logo_h ); ?>;<?php } ?>"<?php } ?>>
							<img src="<?php echo esc_url( $limg ); ?>" alt=""/>
						</a>
						<?php
					}
					elseif( doctor_options('opt_logotype') == "1" && $lsitetitle != "" ) { // Logo - Site Title
						?>
						<a class="navbar-brand desktop-hide mobile-logo site-title" href="<?php echo esc_url( home_url( '/' ) ); ?>">
							<?php 
								if( doctor_options("opt_menuicon_switch") != "0" ) {
									if( doctor_options("opt_logo_icon") != "" ) {
										?><i class="<?php echo esc_attr( doctor_options("opt_logo_icon") ); ?>"></i>
					...
					elseif( doctor_options('opt_logotype') == "3" && $lcustomtxt != "" ) { // Logo - Custom Text
						?>
						<a class="navbar-brand desktop-hide mobile-logo custom-txt" href="<?php echo esc_url( home_url( '/' ) ); ?>">
							<?php 
								if( doctor_options("opt_menuicon_switch") != "0" ) {
									if( doctor_options("opt_logo_icon") != "" ) {
										?><i class="<?php echo esc_attr( doctor_options("opt_logo_icon") ); ?>"></i>
