...
/* Menu Hide Show */
$menucss = "";
if( doctor_options("opt_menu_show") != "0" ) {
	$menucss = " menu_show";
}
else {
	$menucss = " menu_hide";
...
?>
<header class="header_s header_s1 header_s10<?php echo esc_attr($sticky_menu); ?><?php echo esc_attr($menucss); ?>">
	<?php 
	...
	<nav class="navbar ownavigation">
		...
		<div class="container">
			...
			<div class="menu-switch">	
				<a href="javascript:void(0);" title="<?php esc_html_e('menu-switch',"doctor"); ?>"><i class="fa fa-bars"></i></a>
			</div>
